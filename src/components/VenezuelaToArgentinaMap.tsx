...
export default function VenezuelaToArgentinaMap() {
    ...
    const adjustMapHeight = useCallback((): void => {
        if (typeof window !== 'undefined') {
            ...
            const map = document.querySelector('#venezuela-to-argentina-map') as HTMLElement;
            ...
            if (wrapper && header && footer && map) {
                ...
                let calculatedMapHeight = wrapperHeight - headerHeight - footerHeight - 80;
    ...
    return (
        <div id="venezuela-to-argentina-map" class="google-map"/>
    );
}